    ...
    <>
      <style jsx global>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .seal-list { list-style: none; padding: 0; } .seal-list li { padding: 2px 0; font-size: 13px; color: rgba(232,230,225,0.7); line-height: 1.5; } .seal-list li::before { content: '✓ '; color: var(--green); font-weight: 700; }
        ...
        .kv-doc-icon { font-size: 18px; margin-bottom: 4px; } .kv-doc-title { font-size: 12px; font-weight: 700; color: var(--text); margin-bottom: 2px; } .kv-doc-meta { font-size: 10px; color: var(--text3); }
        ...
        .ev-field-label { font-size: 10px; color: var(--text3); font-weight: 600; } .ev-field-val { font-size: 13px; color: var(--text); font-weight: 600; }
      ...
      <section className="cta"><h2>讓 AI 守護你的每一筆流程</h2><p>合規、智慧、一站式。從知識管理到流程自動化，一個平台全搞定。</p><div className="cta-acts"><a href="/signup" className="btn btn-p btn-lg">免費開始使用 →</a><a href="/contact" className="btn btn-w btn-lg">預約 Demo</a></div><div className="cta-note">hello@primestrideatlas.com · 不需信用卡 · 五分鐘完成設定</div></section>

      <footer className="foot"><div className="foot-in"><div className="foot-l">&copy; 2026 PrimeStride Atlas — Enterprise Intelligence Platform</div><div className="foot-links"><a href="/contact">聯繫我們</a><a href="#">Privacy</a><a href="#">Terms</a></div></div></footer>
    </>
  );
}