    ...
    <>
      <style jsx global>{`
        ...
        :root {
          ...
          --light-text: #0f172a;
          --light-text2: #475569;
          --light-border: rgba(10,14,23,0.08);
        }
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-links a { padding: 7px 14px; font-size: 14px; font-weight: 500; color: var(--text3); border-radius: 8px; transition: all 0.15s; }
        ...
        .btn-light { background: var(--light-text); color: white; }
        .btn-light:hover { background: #1e293b; }

        /* ─── Badges ─── */
        .badge { display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; border-radius: 100px; font-size: 12px; font-weight: 600; letter-spacing: 0.03em; }
        ...
        .hero h1 { font-family: 'DM Serif Display', 'Noto Sans TC', serif; font-size: clamp(38px, 5.8vw, 60px); font-weight: 400; line-height: 1.1; color: var(--text); margin-bottom: 10px; letter-spacing: -0.01em; }
        .hero h1 .hl-blue { color: var(--blue-l); }
        .hero h1 .hl-green { color: var(--green-l); }
        .hero-sub-zh { font-family: 'Noto Sans TC', sans-serif; font-size: 18px; color: var(--text3); margin-bottom: 24px; }
        .hero-desc { font-size: 17px; color: var(--text2); max-width: 600px; margin: 0 auto 40px; line-height: 1.8; }
        ...
        .hero-pill { display: flex; align-items: center; gap: 6px; padding: 7px 16px; border-radius: 100px; background: rgba(255,255,255,0.03); border: 1px solid var(--border); font-size: 12px; font-weight: 600; color: var(--text2); }
        ...
        .sec-title { font-family: 'DM Serif Display', 'Noto Sans TC', serif; font-size: clamp(28px, 4vw, 40px); font-weight: 400; line-height: 1.2; margin-bottom: 14px; }
        .sec-light .sec-title { color: var(--light-text); }
        .sec-desc { font-size: 16px; color: var(--text2); line-height: 1.7; }
        ...
        .chat-label { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 6px; }
        .chat-label-user { color: var(--blue-l); }
        .chat-label-ai { color: var(--green-l); }
        .chat-bubble { padding: 16px 20px; border-radius: 12px; font-size: 14.5px; line-height: 1.7; }
        ...
        .chat-zh { font-family: 'Noto Sans TC', sans-serif; font-size: 15.5px; }
        .chat-en-sub { font-size: 12px; color: var(--text3); margin-top: 4px; }
        ...
        .seal-title { font-weight: 700; color: var(--green); margin-bottom: 6px; font-size: 12px; text-transform: uppercase; letter-spacing: 0.04em; }
        .seal-list { list-style: none; padding: 0; }
        .seal-list li { padding: 2px 0; font-size: 13px; color: rgba(232,230,225,0.7); line-height: 1.5; }
        .seal-list li::before { content: '✓ '; color: var(--green); font-weight: 700; }
        ...
        .prob-card h3 { font-size: 16px; font-weight: 700; margin-bottom: 6px; font-family: 'Noto Sans TC', sans-serif; }
        .prob-card p { font-size: 13.5px; color: var(--text2); line-height: 1.6; font-family: 'Noto Sans TC', sans-serif; }
        .prob-stat { margin-top: 12px; font-family: 'JetBrains Mono', monospace; font-size: 24px; font-weight: 700; color: var(--red); }
        ...
        .compare-header { padding: 18px 24px; font-weight: 700; font-size: 14px; background: #f0ede8; }
        ...
        .pillar-feat { display: flex; align-items: flex-start; gap: 10px; font-size: 13.5px; color: var(--text2); line-height: 1.5; font-family: 'Noto Sans TC', sans-serif; }
        .pillar-feat strong { color: var(--text); }
        .pillar-feat-icon { width: 28px; height: 28px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 13px; flex-shrink: 0; margin-top: 1px; }
        ...
        .kv-search-icon { font-size: 15px; } .kv-search-text { font-size: 13px; color: var(--text3); }
        ...
        .kv-doc-icon { font-size: 18px; margin-bottom: 4px; }
        .kv-doc-title { font-size: 12px; font-weight: 700; color: var(--text); margin-bottom: 2px; }
        .kv-doc-meta { font-size: 10px; color: var(--text3); }
        .kv-tag { display: inline-block; padding: 2px 7px; border-radius: 4px; font-size: 10px; font-weight: 600; margin-right: 4px; margin-top: 4px; }
        .kv-chat { padding: 12px 16px; background: var(--blue-glow); border: 1px solid rgba(37,99,235,0.15); border-radius: 10px; font-size: 13px; color: var(--text2); line-height: 1.6; }
        ...
        .wv-btn { padding: 5px 10px; border-radius: 6px; font-size: 11px; font-weight: 600; background: rgba(255,255,255,0.04); border: 1px solid var(--border); color: var(--text3); }
        .wv-btn.active { background: var(--blue); color: white; border-color: var(--blue); }
        .wv-content { padding: 14px; background: rgba(255,255,255,0.02); border: 1px solid var(--border); border-radius: 10px; margin-bottom: 12px; font-size: 13px; color: var(--text2); line-height: 1.7; }
        .wv-preview { padding: 14px; background: var(--green-glow); border: 1px solid rgba(16,185,129,0.15); border-radius: 10px; font-size: 13px; color: rgba(232,230,225,0.8); line-height: 1.6; }
        ...
        .ev-label { font-size: 11px; font-weight: 700; color: var(--text3); margin-bottom: 10px; }
        .ev-input { background: rgba(255,255,255,0.04); border: 1px solid var(--border); border-radius: 10px; padding: 14px 18px; color: var(--text2); font-size: 14px; font-style: italic; margin-bottom: 12px; font-family: 'Noto Sans TC', sans-serif; }
        ...
        .ev-field-label { font-size: 10px; color: var(--text3); font-weight: 600; }
        .ev-field-val { font-size: 13px; color: var(--text); font-weight: 600; }
        .ev-submit { padding: 10px; border-radius: 8px; background: var(--blue); color: white; text-align: center; font-size: 13px; font-weight: 700; }
        ...
        .law-chip { padding: 8px 18px; border-radius: 8px; background: var(--green-glow); border: 1px solid rgba(16,185,129,0.2); font-family: 'JetBrains Mono', monospace; font-size: 12px; color: var(--green-l); font-weight: 500; }
        ...
        .price-list li { padding: 5px 0; font-size: 13.5px; color: var(--text2); }
        ...
        .cta h2 { font-family: 'DM Serif Display', 'Noto Sans TC', serif; font-size: clamp(28px, 4.5vw, 42px); font-weight: 400; margin-bottom: 14px; position: relative; }
        .cta p { font-size: 16px; color: var(--text2); margin-bottom: 36px; max-width: 480px; margin-left: auto; margin-right: auto; position: relative; }
        .cta-acts { display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; margin-bottom: 20px; position: relative; }
        .cta-note { font-size: 13px; color: var(--text3); position: relative; }
        ...
        .foot-links a { font-size: 13px; color: var(--text3); transition: color 0.15s; }
        ...
        @media (max-width: 768px) {
          ...
          .pillar, .pillar.rev { grid-template-columns: 1fr; gap: 28px; direction: ltr; }
      ...
      <nav className={`nav ${navScrolled ? 'sc' : ''}`}>
        <div className="nav-in">
          <a href="/" className="nav-brand"><div className="nav-mark">P</div> PrimeStride Atlas</a>
      ...
      {/* ═══ 2. LIVE DEMO TERMINAL ═══ */}
      <section className="sec sec-dark2" id="demo">
        <div className="con">
          <div className="sec-hd ctr">
            <div className="sec-label sec-label-green">Live Demo</div>
            <div className="sec-title">一句話完成合規請假</div>
            <p className="sec-desc">員工用自然語言說需求，AI 自動解析、合規檢查、送出表單。</p>
          </div>
          <div className="terminal fi">
            <div className="terminal-bar">
              <span className="t-dot t-dot-r" /><span className="t-dot t-dot-y" /><span className="t-dot t-dot-g" />
              <span className="t-title">atlas-eip v2.0 — compliance demo</span>
            </div>
            <div className="terminal-body">
              <div className="chat-msg">
                <div className="chat-label chat-label-user">Employee 員工</div>
                <div className="chat-bubble chat-user">
                  <div className="chat-zh">老闆，我小孩發燒，今天請假兩小時</div>
                  <div className="chat-en-sub">Boss, kid has a fever, taking 2 hours off today</div>
                </div>
              </div>
              <div className="chat-msg">
                <div className="chat-label chat-label-ai">Atlas AI</div>
                <div className="chat-bubble chat-ai">
                  已為您登記 <strong>2 小時家庭照顧假（Family Care Leave）</strong>。您的 2026 年度餘額剩餘 <strong>54 小時</strong>。根據 Project Atlas 的任務分配，已預選 <strong>Kevin Chen</strong> 作為您的代理人。祝早日康復！
                  <div className="compliance-seal">
                    <div className="seal-title">✅ Atlas Compliance Check</div>
                    <ul className="seal-list">
                      <li>依 2026 勞基法，以 1 小時為單位申請</li>
                      <li>未超過年度 56 小時家庭照顧假上限</li>
                      <li>全勤獎金受 Art. 9-1 保障，不受影響</li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      <section className="sec" id="problem">
        <div className="con">
          <div className="sec-hd">
            <div className="sec-label sec-label-blue">企業現況</div>
            <div className="sec-title">2026 法規更嚴格了，你的系統跟上了嗎？</div>
            <p className="sec-desc">勞動部新規、ESG 要求、小時制假別 — 傳統 ERP 無法應對。</p>
          </div>
          <div className="prob-grid">
            {[
              { icon: '⚖️', title: '2026 勞基法合規風險', desc: '家庭照顧假改為小時制、全勤獎金不可扣除 — 違規罰款最高 100 萬。你的系統能自動處理嗎？', stat: 'NT$1M' },
              { icon: '📋', title: 'ERP 流程太繁瑣', desc: '請假要填十個欄位，出差要選八個下拉選單。明明一句話就能說清楚的事情。', stat: '10min' },
              { icon: '📊', title: 'ESG 報告壓力', desc: '國際客戶要求可驗證的勞動數據。手動整理 Excel 報表已經來不及了。', stat: '致命' },
            ].map((p) => (
        ...
        <div className="con">
          ...
          <div className="compare-grid fi">
            ...
            {[
              ...
              { label: '法規合規', legacy: '每年手動更新一次', atlas: '自動同步。2026 勞基法內建於每個流程。' },
              { label: '使用方式', legacy: '選擇「病假」→ 選日期 → 寫理由', atlas: '自然語言。「我生病了，在家休息。」— 完成。' },
              { label: 'ESG 報告', legacy: '手動整理 Excel 數據', atlas: '即時。一鍵產出自動化法規報告。' },
              { label: '代理人', legacy: '員工自己去問同事', atlas: 'AI 讀取組織圖 + 專案資料，建議最佳人選。' },
            ].map((r) => (
              <>{/* eslint-disable-next-line react/jsx-key */}
                <div className="compare-cell"><div className="compare-cell-label">{r.label}</div><p>{r.legacy}</p></div>
                <div className="compare-cell atlas-col"><div className="compare-cell-label">{r.label}</div><p>{r.atlas}</p></div>
              </>
            ))}
          </div>
        </div>
      ...
      <section className="sec">
        <div className="con">
          <div className="pillar fi">
            <div>
              <div className="pillar-label" style={{ color: 'var(--blue-l)' }}>核心一 · AI 知識管理</div>
              ...
              <div className="pillar-features">
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'var(--blue-glow)' }}>🔍</div><div><strong>語意混合搜尋</strong> — 語意理解 + 關鍵字比對，中英文自動偵測</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'rgba(139,92,246,0.1)' }}>💬</div><div><strong>AI 文件對話</strong> — 問問題，得到附來源引用的答案</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'rgba(245,158,11,0.1)' }}>🏷️</div><div><strong>自動標籤</strong> — GPT-4o-mini 自動分類，不需手動整理</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'var(--green-glow)' }}>🌐</div><div><strong>知識圖譜</strong> — 互動式視覺化，探索文件之間的關聯</div></div>
              </div>
            </div>
            <div className="pillar-visual">
              <div className="kv-card">
                ...
                <div className="kv-row">
                  <div className="kv-doc"><div className="kv-doc-icon">📄</div><div className="kv-doc-title">Q4 業務報告</div><div className="kv-doc-meta">v2.1 · 2 天前更新</div><div><span className="kv-tag" style={{ background: 'var(--blue-glow)', color: 'var(--blue-l)' }}>報告</span><span className="kv-tag" style={{ background: 'rgba(139,92,246,0.1)', color: 'var(--violet)' }}>業務</span></div></div>
                  <div className="kv-doc"><div className="kv-doc-icon">📋</div><div className="kv-doc-title">新人培訓手冊</div><div className="kv-doc-meta">v1.3 · 已發佈</div><div><span className="kv-tag" style={{ background: 'rgba(245,158,11,0.1)', color: 'var(--amber)' }}>培訓</span><span className="kv-tag" style={{ background: 'var(--green-glow)', color: 'var(--green)' }}>HR</span></div></div>
                </div>
                <div className="kv-chat">💬 根據 Q4 報告，本季營收成長了 23%，主要由企業客戶帶動。<span style={{ fontSize: 11, color: 'var(--text3)' }}> — 來源: Q4 業務報告 p.12</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec sec-dark2">
        <div className="con">
          <div className="pillar rev fi">
            <div>
              <div className="pillar-label" style={{ color: 'var(--green-l)' }}>核心二 · AI 智慧工具</div>
              ...
              <div className="pillar-features">
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'var(--green-glow)' }}>✨</div><div><strong>AI 寫作助手</strong> — 改善、翻譯、縮短、擴展、調整語氣</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'rgba(245,158,11,0.1)' }}>📤</div><div><strong>五格式匯出</strong> — PDF、Word、HTML、Markdown、純文字</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'rgba(239,68,68,0.1)' }}>🔑</div><div><strong>公開 API v1</strong> — RESTful API，外部系統可直接串接</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'var(--blue-glow)' }}>📝</div><div><strong>協作工具</strong> — 行內留言、文件範本、版本追蹤</div></div>
              </div>
            </div>
            <div className="pillar-visual">
        ...
        <div className="con">
          <div className="pillar fi">
            <div>
              ...
              <div className="pillar-features">
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'var(--blue-glow)' }}>📝</div><div><strong>NLP 智慧表單</strong> — 自然語言自動填寫，支援中英文</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'var(--green-glow)' }}>🛡️</div><div><strong>2026 合規引擎</strong> — 小時制假別、全勤獎金保護、最低工資檢查</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'rgba(245,158,11,0.1)' }}>✅</div><div><strong>審核流程</strong> — 主管即時審核，批次核准/駁回</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'rgba(139,92,246,0.1)' }}>🤖</div><div><strong>Agentic Auditor</strong> — AI 預先審查，自動附加 SOP 相關政策</div></div>
                <div className="pillar-feat"><div className="pillar-feat-icon" style={{ background: 'rgba(239,68,68,0.1)' }}>📊</div><div><strong>ESG 報告</strong> — 一鍵產出性別中立假別、加班合規報告</div></div>
              </div>
            </div>
            <div className="pillar-visual">
              <div className="ev-card">
                <div className="ev-label">🤖 AI 智慧填寫 + 合規檢查</div>
                <div className="ev-input">{'"我下週一到週三要請特休，因為要回南部探親"'}</div>
                <div className="ev-arrow">↓ AI 自動解析 + 合規驗證</div>
                <div className="ev-fields">
                  ...
                  <div className="ev-field"><div className="ev-field-label">開始日期 Start</div><div className="ev-field-val">2026-03-09</div></div>
                  <div className="ev-field"><div className="ev-field-label">結束日期 End</div><div className="ev-field-val">2026-03-11</div></div>
                ...
                <div className="ev-compliance">
                  <div className="ev-compliance-title">✅ Compliance Seal</div>
                  <div className="ev-compliance-text">符合 2026 勞基法 · 特休餘額充足 (4/7) · 已建議代理人: Kevin Chen</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ═══ 6. COMPLIANCE BANNER ═══ */}
      <section className="compliance-sec" id="compliance">
        <div className="con">
          <div className="sec-label" style={{ color: 'var(--green-l)', textAlign: 'center' }}>Built for 2026</div>
          <div className="sec-title" style={{ textAlign: 'center', color: '#fff', marginBottom: 12 }}>每一筆流程都附帶 Compliance Seal</div>
          <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.5)', fontSize: 15, maxWidth: 550, margin: '0 auto 32px', lineHeight: 1.7 }}>
            台灣勞動部 2026 年新規：小時制假別、比例計算、全勤獎金保護。Atlas 在送出前自動檢查每一筆申請。
          </p>
          <div className="law-chips">
            <span className="law-chip">家庭照顧假 56hr/年</span>
            <span className="law-chip">育嬰假 1 天為單位</span>
            <span className="law-chip">病假 Art 9-1</span>
            <span className="law-chip">基本工資 NT$29,500</span>
            <span className="law-chip">加班上限 46hr/月</span>
            <span className="law-chip">ESG S-Pillar</span>
          </div>
          <div style={{ textAlign: 'center' }}>
            <a href="#demo" className="btn btn-p">See Compliance in Action →</a>
          </div>
        </div>
      </section>
      ...
      <section className="sec sec-light">
        <div className="con">
          <div className="sec-hd ctr">
            <div className="sec-label sec-label-dark">為什麼選擇 Atlas</div>
            <div className="sec-title" style={{ color: 'var(--light-text)' }}>從第一天就為台灣企業設計</div>
          </div>
          <div className="why-grid">
            {[
              { icon: '🛡️', title: '2026 法規內建', desc: '不是外掛模組，而是從核心邏輯就內建勞基法合規檢查。' },
              { icon: '💬', title: '自然語言驅動', desc: '用一句話取代十個欄位。AI 理解你的需求，自動填寫表單。' },
              { icon: '🔗', title: '知識 + 流程融合', desc: 'SOP 不再是獨立文件。AI 讀取政策後直接執行合規流程。' },
              { icon: '📊', title: '一鍵 ESG 報告', desc: '勞動數據自動追蹤，隨時產出符合國際標準的 ESG 報告。' },
            ].map((w) => (
      ...
      <section className="sec sec-dark2" id="pricing">
        <div className="con">
          <div className="sec-hd ctr">
            <div className="sec-label sec-label-blue">方案價格</div>
            <div className="sec-title">Enterprise Intelligence，合理價格</div>
      ...
      <footer className="foot">
        <div className="foot-in">
          <div className="foot-l">&copy; 2026 PrimeStride Atlas — Enterprise Intelligence Platform</div>
          <div className="foot-links"><a href="/contact">聯繫我們</a><a href="#">Privacy</a><a href="#">Terms</a></div>
        </div>
      </footer>
    </>
  );
